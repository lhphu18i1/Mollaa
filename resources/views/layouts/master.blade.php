                ...
                <div class="container">
                    ...
                    <div class="header-right">
                        <ul class="top-menu">
                            <li>
                                <ul>
                                    <li><i class="icon-phone"></i>@lang('messages.call') 038 987 3097</li>
                                    <li><a href="contact.html">@lang('messages.contact')</a></li>
                                    <li><a href="{{ route('get.customer.login') }}"><i class="icon-user"></i>@lang('messages.login')</a></li>
                                </ul>
                            </li>
                        </ul><!-- End .top-menu -->
                        ...
                        <div class="header-search">
                            ...
                            <form action="#" method="get">
                                <div class="header-search-wrapper">
                                    ...
                                    <input type="search" class="form-control" name="q" id="q" placeholder="@lang('messages.search_pro')" required>
                        ...
                        <div class="dropdown cart-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="dropdown-cart-action">
                                    <a href="cart.html" class="btn btn-primary">@lang('messages.view_cart')</a>
                                    <a href="checkout.html" class="btn btn-outline-primary-2"><span>@lang('messages.checkout')</span><i class="icon-long-arrow-right"></i></a>
                                </div><!-- End .dropdown-cart-total -->
