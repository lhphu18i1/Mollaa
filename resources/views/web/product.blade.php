        ...
        @section('content')
            <main class="main">
                <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
                    <div class="container">
                        <h1 class="page-title">@lang('messages.product')<span>@lang('messages.shop')</span></h1>
                    </div><!-- End .container -->
                </div><!-- End .page-header -->
                <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
                    <div class="container">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('messages.product')</li>
                        </ol>
                    </div><!-- End .container -->
                                        ...
                                        <div class="toolbox-sort">
                                            ...
                                            <div class="select-custom">
                                                <select name="sortby" id="sortby" class="form-control">
                                                    <option value="popularity" selected="selected">@lang('messages.popular')</option>
                                                    <option value="rating">@lang('messages.rate')</option>
                                                    <option value="date">@lang('messages.date')</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="product product-7 text-center">
                                                <figure class="product-media">
                                                    ...
                                                    <div class="product-action-vertical">
                                                        <a href="#"
                                                            class="btn-product-icon btn-wishlist btn-expandable"><span>@lang('messages.add_wishlist')</span></a>
                                                        <a href="popup/quickView.html"
                                                            class="btn-product-icon btn-quickview"
                                                            title="Quick view"><span>@lang('messages.quick_view')</span></a>
                                                        <a href="#" class="btn-product-icon btn-compare"
                                                            title="Compare"><span>@lang('messages.compare')</span></a>
                                                    </div><!-- End .product-action-vertical -->

                                                    <div class="product-action">
                                                        <a href="#" class="btn-product btn-cart"><span>@lang('messages.add_cart')</span></a>
                                                    </div><!-- End .product-action -->
                                                </figure><!-- End .product-media -->

                                                <div class="product-body">
                                                    <div class="product-cat">
                                                        <a href="#">@lang('messages.women')</a>
                                                    </div><!-- End .product-cat -->
